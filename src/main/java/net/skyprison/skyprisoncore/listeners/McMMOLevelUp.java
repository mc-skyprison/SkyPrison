...
public class McMMOLevelUp implements Listener {
    ...
    public void onMcMMOLevelUp(McMMOPlayerLevelUpEvent event) {
        ...
        if(mcPlayer.getPowerLevel() == 250) {
            plugin.asConsole("lp user " + event.getPlayer().getName() + " permission set deluxetags.tag.powerlevel1");
        } else if(mcPlayer.getPowerLevel() == 500) {
            plugin.asConsole("lp user " + event.getPlayer().getName() + " permission set deluxetags.tag.powerlevel2");
        } else if(mcPlayer.getPowerLevel() == 750) {
            plugin.asConsole("lp user " + event.getPlayer().getName() + " permission set deluxetags.tag.powerlevel3");
        } else if(mcPlayer.getPowerLevel() == 1000) {
            plugin.asConsole("lp user " + event.getPlayer().getName() + " permission set deluxetags.tag.powerlevel4");
        } else if(mcPlayer.getPowerLevel() == 1500) {
            plugin.asConsole("lp user " + event.getPlayer().getName() + " permission set deluxetags.tag.powerlevel5");
        } else if(mcPlayer.getPowerLevel() == 2000) {
            plugin.asConsole("lp user " + event.getPlayer().getName() + " permission set deluxetags.tag.powerlevel6");
        }
