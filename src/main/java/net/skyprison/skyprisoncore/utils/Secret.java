...
public record Secret(int id, String name, ItemStack displayItem, String category, String type, Integer position,
                     String rewardType, Integer reward, long cooldown) {
    public void setCooldown(UUID pUUID) {
